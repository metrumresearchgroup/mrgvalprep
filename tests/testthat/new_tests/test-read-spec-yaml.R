...
test_that("read_spec_yaml() supports stories-only mode [TST-FOO-029]", {
...
test_that("read_spec_yaml() can read stories from multiple YAMLs [TST-FOO-030]", {
...
test_that("read_spec_yaml() supports requirements [TST-FOO-031]", {
  spec <- read_spec_yaml(
...
test_that("read_spec_yaml() aborts on repeated IDs [TST-FOO-032]", {

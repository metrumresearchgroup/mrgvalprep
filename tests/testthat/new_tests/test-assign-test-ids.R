...
withr::with_options(
  new = list(
    ...
    test_that("assign_test_ids() returns the correct dataframe [TST-FOO-001]", {
    ...
    test_that("assign_test_ids() updates test files correctly [TST-FOO-002]", {
      skip_if_over_rate_limit_github()
      skip_if_no_github_pat()
    ...
    test_that("assign_test_ids() spits back correct warnings [TST-FOO-003]", {
      skip_if_over_rate_limit_github()
      skip_if_no_github_pat()

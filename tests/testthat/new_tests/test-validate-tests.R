...
test_that("validate_tests returns expected df [TST-FOO-035]", {
...
test_that("validate_tests writes output files [TST-FOO-036]", {
  skip_if_no_github_pat()
...
test_that("validate_tests returns expected df with extra tests [TST-FOO-037]", {
  skip_if_no_github_pat()

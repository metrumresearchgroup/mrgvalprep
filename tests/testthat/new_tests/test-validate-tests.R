...
test_that("validate_tests returns expected df [TST-FOO-032]", {
...
test_that("validate_tests writes output files [TST-FOO-033]", {
  skip_if_no_github_pat()
...
test_that("validate_tests returns expected df [TST-FOO-032] with extra tests [TST-FOO-034]", {
  skip_if_no_github_pat()

...
withr::with_options(list(rbabylon.model_directory = NULL), {
  ...
  test_that("submit_model(.dry_run=T) returns correct command string [TST-FOO-104]",
            {
  ...
  test_that("submit_model(.dry_run=T) with .ctl input parses correctly [TST-FOO-105]",
            {
  ...
  test_that("submit_model(.dry_run=T) with .mod input and .yml file parses correctly [TST-FOO-106]",
            {
              withr::with_options(list(rbabylon.bbi_exe_path = "bbi"), {
  ...
  test_that("submit_model(.dry_run=T) with file path no extension parses correctly [TST-FOO-107]",
            {
              withr::with_options(list(rbabylon.bbi_exe_path = "bbi"), {
  ...
  test_that("submit_model(.dry_run=T) with bbi_nonmem_model object parses correctly [TST-FOO-108]",
            {
              withr::with_options(list(rbabylon.bbi_exe_path = "bbi"), {
                # correctly parsing yaml
                expect_identical(
...
withr::with_options(list(rbabylon.bbi_exe_path = "bbi",
  ...
  test_that("submit_model(.dry_run=T) with numeric input parses correctly [TST-FOO-109]",
            {
              # correctly parsing yaml
              expect_identical(
  ...
  test_that("submit_models(.dry_run=T) with list input simple [TST-FOO-110]",
            {
              # read first model
              mod1 <- read_model(1)
  ...
  test_that("submit_models(.dry_run=T) with list input, 2 arg sets [TST-FOO-111]",
            {
              # read first model
              mod1 <- read_model(1)
  ...
  test_that("submit_models(.dry_run=T) errors with bad input [TST-FOO-112]",
            {
              # read first model
              mod1 <- read_model(1)
  ...
  test_that("submit_models(.dry_run=T) with character and numeric input yaml [TST-FOO-113]",
            {
              # read first model
              mod1 <- read_model(1)
  ...
  test_that("submit_models(.dry_run=T) with character mixed extensions [TST-FOO-114]",
            {
              # read first model
              mod1 <- read_model(1)

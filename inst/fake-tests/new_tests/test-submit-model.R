...
withr::with_options(list(rbabylon.model_directory = NULL), {
  ...
  test_that("submit_model(.dry_run=T) returns correct command string [MRGVAL-TEST-0105]",
            {
  ...
  test_that("submit_model(.dry_run=T) with .ctl input parses correctly [MRGVAL-TEST-0106]",
            {
  ...
  test_that("submit_model(.dry_run=T) with .mod input and .yml file parses correctly [MRGVAL-TEST-0107]",
            {
              withr::with_options(list(rbabylon.bbi_exe_path = "bbi"), {
  ...
  test_that("submit_model(.dry_run=T) with file path no extension parses correctly [MRGVAL-TEST-0108]",
            {
              withr::with_options(list(rbabylon.bbi_exe_path = "bbi"), {
  ...
  test_that("submit_model(.dry_run=T) with bbi_nonmem_model object parses correctly [MRGVAL-TEST-0109]",
            {
              withr::with_options(list(rbabylon.bbi_exe_path = "bbi"), {
                # correctly parsing yaml
                expect_identical(
...
withr::with_options(list(rbabylon.bbi_exe_path = "bbi",
  ...
  test_that("submit_model(.dry_run=T) with numeric input parses correctly [MRGVAL-TEST-0110]",
            {
              # correctly parsing yaml
              expect_identical(
  ...
  test_that("submit_models(.dry_run=T) with list input simple [MRGVAL-TEST-0111]",
            {
              # read first model
              mod1 <- read_model(1)
  ...
  test_that("submit_models(.dry_run=T) with list input, 2 arg sets [MRGVAL-TEST-0112]",
            {
              # read first model
              mod1 <- read_model(1)
  ...
  test_that("submit_models(.dry_run=T) errors with bad input [MRGVAL-TEST-0113]",
            {
              # read first model
              mod1 <- read_model(1)
  ...
  test_that("submit_models(.dry_run=T) with character and numeric input yaml [MRGVAL-TEST-0114]",
            {
              # read first model
              mod1 <- read_model(1)
  ...
  test_that("submit_models(.dry_run=T) with character mixed extensions [MRGVAL-TEST-0115]",
            {
              # read first model
              mod1 <- read_model(1)
